const en = {
  ...
  'Create Rule': 'Create Rule',
  'Edit Rule': 'Edit Rule',
  'Create a new auto group rule.': 'Create a new auto group rule.',
  'Update the auto group rule.': 'Update the auto group rule.',
  ...
  'Recent N Hours Spend (USD)': 'Recent N Hours Spend (USD)',
  "Yesterday's Spend (USD)": "Yesterday's Spend (USD)",
  'Net Top-up (USD)': 'Net Top-up (USD)',
  'Recent N Hours Top-up (USD)': 'Recent N Hours Top-up (USD)',
  "Yesterday's Top-up (USD)": "Yesterday's Top-up (USD)",
  'Total Request Count': 'Total Request Count',
  'Recent N Hours Request Count': 'Recent N Hours Request Count',
  'Filter by name or target group...': 'Filter by name or target group...',
  ...
  'Open menu': 'Open menu',
  'This will permanently delete rule': 'This will permanently delete rule',
  ...
  'User IDs': 'User IDs',
  'Comma-separated list of user IDs': 'Comma-separated list of user IDs',
  'e.g. 1, 2, 3': 'e.g. 1, 2, 3',
  'Enrolling...': 'Enrolling...',
  ...
  'Unenroll User?': 'Unenroll User?',
  'This will unenroll': 'This will unenroll',
