const zh: Record<string, string> = {
  ...
  'Create Rule': '创建规则',
  'Edit Rule': '编辑规则',
  'Create a new auto group rule.': '创建新的自动分组规则。',
  'Update the auto group rule.': '更新自动分组规则。',
  ...
  'The group users will be assigned to when rule matches':
    '规则匹配时用户将被分配到的分组',
  'Match Mode': '匹配模式',
  'Match All (AND)': '全部满足 (AND)',
  'Match Any (OR)': '任一满足 (OR)',
  'Add Condition': '添加条件',
  Metric: '指标',
  Op: '运算符',
  'Hours (N)': '时间窗口 (小时)',
  ...
  'Save changes': '保存',
  'Saving...': '保存中...',
  'Total Spend (USD)': '累计消费 (USD)',
  'Recent N Hours Spend (USD)': '近 N 小时消费 (USD)',
  "Yesterday's Spend (USD)": '昨日消费 (USD)',
  'Net Top-up (USD)': '净充值额 (USD)',
  'Recent N Hours Top-up (USD)': '近 N 小时充值 (USD)',
  "Yesterday's Top-up (USD)": '昨日充值 (USD)',
  'Total Request Count': '累计请求数',
  'Recent N Hours Request Count': '近 N 小时请求数',
  'Filter by name or target group...': '搜索名称或目标分组...',
  'Filter by username...': '搜索用户名...',
  'No Rules Found': '暂无规则',
  'No Enrollments Found': '暂无纳入记录',
  'Match All': '全部匹配',
  'Match Any': '任一匹配',
  conditions: '个条件',
  'Open menu': '打开菜单',
  'This will permanently delete rule': '将永久删除规则',
  ...
  'Enroll Users': '纳入用户',
  'User IDs': '用户 ID',
  'Comma-separated list of user IDs': '以逗号分隔的用户 ID 列表',
  'e.g. 1, 2, 3': '例如 1, 2, 3',
  'Enrolling...': '纳入中...',
  ...
  'Rule ID': '规则 ID',
  'Enrolled At': '纳入时间',
  'Unenroll User?': '取消纳入用户？',
  'This will unenroll': '将取消纳入',
  'Unenrolling...': '取消中...',
  'Trigger Sweep': '触发扫描',
  'Sweeping...': '扫描中...',
